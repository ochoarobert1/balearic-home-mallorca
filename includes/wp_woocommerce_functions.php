...
add_action( 'after_setup_theme', 'balearic_woocommerce_support' );
function balearic_woocommerce_support() {
...
add_action('woocommerce_before_main_content', 'balearic_woocommerce_custom_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'balearic_woocommerce_custom_wrapper_end', 10);

function balearic_woocommerce_custom_wrapper_start() {
    echo '<section id="main" class="container-fluid"><div class="row"><div class="woocustom-main-container col-12">';
}

function balearic_woocommerce_custom_wrapper_end() {
