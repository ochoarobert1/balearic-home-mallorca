...
<main class="container-fluid p-0" role="main" itemscope itemprop="mainContentOfPage" itemtype="http://schema.org/Blog">
    <div class="row no-gutters">
        <section class="home-main-section col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container-fluid container-special-fluid p-0">
                <div class="row no-gutters align-items-center">
                    <div class="home-main-content col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 order-xl-1 order-lg-1 order-md-12 order-sm-12 order-12" data-aos="fade-in" data-aos-delay="300">
                        <?php the_content(); ?>
                    </div>
                    <picture class="home-main-picture col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 order-xl-12 order-lg-12 order-md-1 order-sm-1 order-1" data-aos="fade-in" data-aos-delay="600">
        ...
        <section class="home-locations-section col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row align-items-top">
                    <div class="home-locations-title title-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" data-aos="fade-in" data-aos-delay="300">
                    ...
                    <?php $delay = 150 * $i; ?>
                    <article class="home-location-tax col-xl col-lg col-md col-sm-12 col-12" data-aos="fade-in" data-aos-delay="<?php echo $delay; ?>">
                        <div class="wrapper">
                            <picture>
        ...
        <section class="home-services-section col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row align-items-top">
                    <div class="home-services-title title-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" data-aos="fade-in" data-aos-delay="300">
                    ...
                    <?php $delay = 250 * $i; ?>
                    <article class="home-service-item col-xl col-lg col-md col-sm-6 col-12" data-aos="fade-in" data-aos-delay="<?php echo $delay; ?>">
                        <a href="<?php echo $item['button_link']; ?>" title="<?php echo $item['title']; ?>">
        ...
        <section class="home-contact-section col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row align-items-center">
                    <div class="home-contact-preview col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12" data-aos="fade-in" data-aos-delay="300">
                    ...
                    <div class="home-contact-info-container col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="row">
                            ...
                            <article class="home-contact-item col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12" data-aos="fade-in" data-aos-delay="600">
        ...
        <section class="main-contact-map-container col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="container">
                <div class="row">
                    <div class="main-contact-map-content col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" data-aos="fade-in" data-aos-delay="300">
