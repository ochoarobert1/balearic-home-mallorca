...
<head>
    ...
    <title>{titulo}</title> <!--   The title tag shows in email notifications, like Android 4.4. -->
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 20px; font-family: sans-serif; font-size: 15px; line-height: 20px; color: #555555;">
                                    <h1 style=" text-align: center; margin: 0 0 10px 0; font-size: 25px; line-height: 30px; color: #333333; font-weight: bold;">{titulo}</h1>
                                    <hr>
                                    <h3>{locals_titulo}: </h3>
                                    <p style="margin: 0;">{locals}</p>

                                    <h3>CheckIn / CheckOut: </h3>
                                    <p style="margin: 0;">{fechas}</p>

                                    <h3>{cantidad_adultos_titulo}: </h3>
                                    <p style="margin: 0;">{cantidad_adultos}</p>

                                    <h3>{cantidad_kids_titulo}: </h3>
                                    <p style="margin: 0;">{cantidad_kids}</p>
